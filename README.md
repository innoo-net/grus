...
Google Apps Script の HTML Service 上で手動マウントする場合は、`coreUrl` を絶対URLで明示すると安全です。
...
<script>
  ...
  GrusLoader.load({
    lang: 'ja',
    coreUrl: 'https://cdn.jsdelivr.net/gh/innoo-net/grus@master/dist/grus.core.js',
    localeBaseUrl: 'https://cdn.jsdelivr.net/gh/innoo-net/grus@master/locales',
    fields: grusFields,
    target: '#builder',
    urlSync: false
